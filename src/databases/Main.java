...
public class Main {
    ...
    private static void setUpDatabase() {
        DatabaseConnection.insertIntoHotel(1,"Hotel Jökull","Höfn", false, true, true, true, false, true);
        DatabaseConnection.insertIntoRoom("Hotel Jökull", 2, 0, 12879,1);
        DatabaseConnection.insertIntoRoom("Hotel Jökull", 2, 2, 18579,2);
        DatabaseConnection.insertIntoHotel(2,"CenterHotel Plaza","Reykjavík", true, false, false, true, true, false);
        ...
        DatabaseConnection.insertIntoHotel(3,"Hotel Borg","Keflavík", true, true, true, true, false, false);
        DatabaseConnection.insertIntoRoom("Hotel Borg", 2, 0, 15589,5);
        DatabaseConnection.insertIntoRoom("Hotel Borg", 2, 1, 17789,6);
        DatabaseConnection.insertIntoHotel(4,"UMI Hotel","Eyvindarhólar", true, true, true, false, false, false);
        DatabaseConnection.insertIntoRoom("UMI Hotel", 1, 0, 12879,7);
        DatabaseConnection.insertIntoHotel(5,"Fosshotel Lind","Vestmannaeyjar", false, true, false, true, true, true);
        ...
        DatabaseConnection.insertIntoHotel(6,"Hotel Fransiskus","Stykkishólmur", true, false, false, true, false, true);
        ...
        DatabaseConnection.insertIntoHotel(7,"Hotel Rjúkandi","Egilsstaðir", true, true, true, true, true, false);
        DatabaseConnection.insertIntoRoom("Hotel Rjúkandi", 2, 0, 11458,13);
        DatabaseConnection.insertIntoHotel(8,"Hotel Acco","Akureyri", false, true, false, true, true, true);
        DatabaseConnection.insertIntoRoom("Hotel Acco", 1, 1, 15749,14);
        DatabaseConnection.insertIntoRoom("Hotel Acco", 1, 0, 14469,15);
        DatabaseConnection.insertIntoHotel(9,"Geo Hótel ","Grindavík", true, false, false, true, false, true);
        ...
        DatabaseConnection.insertIntoHotel(10,"Hafdals Hotel","Akureyri", true, false, true, true, false, true);
        DatabaseConnection.insertIntoRoom("Hafdals Hotel", 2, 0, 17852,19);
        DatabaseConnection.insertIntoRoom("Hafdals Hotel", 2, 1, 16632,20);
        DatabaseConnection.insertIntoHotel(11,"Hotel Viking","Egilsstaðir", false, false, false, true, false, false);
        DatabaseConnection.insertIntoRoom("Hotel Viking", 2, 1, 17741,21);
        DatabaseConnection.insertIntoRoom("Hotel Viking", 2, 0, 12879,22);
        DatabaseConnection.insertIntoHotel(12,"City Park Hotel","Reykjavík", true, false, true, true, true, true);
        DatabaseConnection.insertIntoRoom("City Park Hotel", 2, 0, 19987,23);
        DatabaseConnection.insertIntoHotel(13,"Hotel Tangs","Ísafjörður", false, true, false, true, false, true);
        DatabaseConnection.insertIntoRoom("Hotel Tangs", 2, 2, 18214,24);
        DatabaseConnection.insertIntoRoom("Hotel Tangs", 1, 0, 12245,25);
        DatabaseConnection.insertIntoHotel(14,"Hotel Lækur","Hella", true, true, true, true, false, true);
        DatabaseConnection.insertIntoRoom("Hotel Lækur", 2, 1, 14579,26);
        DatabaseConnection.insertIntoRoom("Hotel Lækur", 2, 0, 23657,27);
        DatabaseConnection.insertIntoHotel(15,"Borealis Hotel","Borgarnes", false, true, true, true, false, false);
        ...
        DatabaseConnection.insertIntoHotel(16,"Hotel húsafell","Húsafell", true, true, true, true, false, true);
